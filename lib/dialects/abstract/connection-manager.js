...
var Pooling = require('generic-pool')
  ...
  , ConnectionManager
  , registeredProcessExitEvent = false;
...
ConnectionManager = function(dialect, sequelize) {
  ...
  if (!registeredProcessExitEvent) {
    ...
    registeredProcessExitEvent = true;
  }
};
...
ConnectionManager.prototype.onProcessExit = function() {
  if (this.pool) {
    clearTimeout(this.pool._removeIdleTimer);
    this.pool._availableObjects.forEach((o) => this.pool.destroy(o.obj));
    this.pool._removeIdle();
    // var self = this;
